...
var AudioConfig_1 = __webpack_require__(41);
    ...
    PullAudioInputStreamImpl.prototype.Attach = function (audioNodeId) {
        ...
        return this.TurnOn()
            ...
            return {
                ...
                Read: function () {
                    var readBuff = new ArrayBuffer(4096);
                    _this.callback.read(readBuff);
...
var AudioStreamFormatImpl = /** @class */ (function (_super) {
    ...
    function AudioStreamFormatImpl(samplesPerSec, bitsPerSample, channels) {
        ...
        _this.avgBytesPerSec = _this.samplesPerSec * _this.channels * _this.bitsPerSample;
...
//
var Exports_1 = __webpack_require__(1);
var WebsocketMessageAdapter_1 = __webpack_require__(16);
...
var SpeechConfigImpl = /** @class */ (function (_super) {
    ...
    Object.defineProperty(SpeechConfigImpl.prototype, "endpointId", {
        ...
        set: function (value) {
            this.privProperties.setProperty(Exports_2.PropertyId.SpeechServiceConnection_Endpoint, value);
        },
        enumerable: true,
        configurable: true
    });
...
var ServiceTelemetryListener_Internal_1 = __webpack_require__(65);
...
var Recognizer = /** @class */ (function () {
    ...
    function Recognizer(audioConfig) {
        Contracts_1.Contracts.throwIfNull(audioConfig, "audioConfig");
        ...
        */
        switch (event.Name) {
            ...
            case "SpeechHypothesisEvent":
                {
                    var evResult = event;
                    var result = new Exports_2.SpeechRecognitionResult(undefined, undefined, evResult.Result.Text, evResult.Result.Duration, evResult.Result.Offset, undefined, JSON.stringify(evResult.Result), undefined);
                    var ev = new Exports_2.SpeechRecognitionEventArgs(result, 0 /*todo*/, evResult.SessionId);
                    if (!!this.recognizing) {
                        try {
...
var IntentRecognizer = /** @class */ (function (_super) {
    ...
    function IntentRecognizer(speechConfig, audioConfig) {
        var _this = this;
        Contracts_1.Contracts.throwIfNull(speechConfig, "speechConfig");
        ...
        */
        switch (event.Name) {
            ...
            case "SpeechHypothesisEvent":
                {
                    var evResult = event;
                    var result = new Exports_2.IntentRecognitionResult(undefined, undefined, undefined, undefined, undefined, undefined, undefined, JSON.stringify(evResult.Result), undefined);
...
var TranslationRecognizer = /** @class */ (function (_super) {
    ...
    TranslationRecognizer.prototype.FireEventForResult = function (evResult) {
        ...
        var result = new Exports_2.TranslationRecognitionResult(translations, undefined, Exports_2.ResultReason.TranslatedSpeech, evResult.Result.Text, evResult.Result.Duration, evResult.Result.Offset, undefined, JSON.stringify(evResult.Result), undefined);
...
var CancellationDetails = /** @class */ (function () {
    ...
    CancellationDetails.fromResult = function (result) {
        var simpleSpeech = JSON.parse(result.json);
        var reason = Exports_2.CancellationReason.EndOfStream;
